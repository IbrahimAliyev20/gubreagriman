              ...
              <div className="animate-pulse">
                <div className="flex flex-col md:grid md:grid-cols-9 md:grid-rows-6 gap-4 md:gap-4 h-auto md:h-[600px]">
                  ...
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="relative overflow-hidden bg-[#F6F6F6] p-6 md:p-8 min-h-[220px] md:min-h-0 flex flex-col justify-end rounded-[20px] gap-4 md:gap-4 border-[#BDBDBD] border-2"
                    >
              ...
              <div className="h-[60px] md:h-[100px] relative overflow-hidden">
                <div className="flex items-center gap-8 md:gap-16 h-full animate-pulse">
                  {[...Array(6)].map((_, i) => (
                    <div
                      key={i}
                      className="w-20 md:w-32 h-12 md:h-16 bg-gray-200 rounded"
                    ></div>
                  ))}
                </div>
              </div>
